...
import engine.graph.BlockAStar.LDDB.bitwise.LDDB_bitwise;
import engine.graph.BlockAStar.LDDB.bitwise.PairOfCoords_bitwise;
import utility.Coordinate;
import utility.Pair;

public class LDDBCreator_geobit {

	private final static CompressionType compressionType = CompressionType.geobit;
	...
	public static void createDB(ExtensionType extensionType) {
		...
		LDDB_geobit lddb = new LDDB_geobit(db,conversionTable);
	...
	private static void saveLDDB(LDDB_geobit lddb, ExtensionType extensionType) {
