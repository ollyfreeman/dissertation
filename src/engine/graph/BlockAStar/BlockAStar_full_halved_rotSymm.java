...
public class BlockAStar_full_halved_rotSymm extends AlgorithmData {
	...
	public BlockAStar_full_halved_rotSymm(Map map, Coordinate start, Coordinate goal) {
		super();
			this.source = start;
			this.goal = goal;
	...
	protected void expand(Block currentBlock, LinkedList<Coordinate> y, PriorityQueue<Block> openSet) {
		LinkedList<Coordinate> rotatedY = new LinkedList<Coordinate>();
