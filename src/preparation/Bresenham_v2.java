...
public class Bresenham_v2 {
	...
	public static void main(String[] args) {
		Map map = MapGenerator.generateMap(40, 40, 10, 100);
		Graph graph = GraphGenerator.generateGraph(map);
		map.printMap();
		Node n = graph.get2010();
		if(n==null) {
			System.out.println("Oops, no 20,10");
		} else {
			System.out.println("Is 2010 visible?" + isVisible(graph.getHead(), n));
		}
	}
