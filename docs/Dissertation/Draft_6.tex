...
\centering
  ...
  \begin{tikzpicture}
    ...
    \node at (0,1.1) {\includegraphics[width=.9\textwidth]{strange.png}};
  \end{tikzpicture}
...
\centering
  ...
  \begin{tikzpicture}
    \filldraw[color=white,fill=white] (-3,-4.5) rectangle (3,4.5); 
    \node at (0,1.6) {\includegraphics[width=.9\textwidth]{nodesExpanded.png}};
  \end{tikzpicture}
